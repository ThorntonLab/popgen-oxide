...
//     for (i, j) in counts.iter_sites_in(0).unwrap().zip(reduced_counts.iter_sites_in(0).unwrap()) {
//         assert_eq!(i, j)
//     }
// }
// 
...
//     for (i, j) in counts[0].iter().zip(reduced_counts.iter_sites_in(0).unwrap()) {
//         assert_eq!(i, j)
//     }
//     for (i, j) in counts_two_windows[1].iter().zip(reduced_counts.iter_sites_in(0).unwrap()) {
//         assert_eq!(i, j)
//     }
// }
// 
...
//             num_iterated += 1;
//         }
//         assert_eq!(num_iterated, counts.num_sites());
//     }
// }
// 
// #[test]
...
//         .iter_sites_in(0)
//         .unwrap()
//         .zip(counts2.iter_sites_in(0).unwrap())
//     {
//         assert_eq!(i, j)
//     }
//     generate_counts_and_validate(
