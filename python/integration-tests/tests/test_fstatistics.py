...
@given(anc_seed=integers(1, 42000000), mut_seed=integers(1, 42000000), num_samples=integers(8, 100))
def test_f2_all_sample_nodes_infinite_sites_mutation_vary_sample_size(anc_seed, mut_seed, num_samples):
    yaml = """
    time_units: generations
    demes:
     - name: ancestor
    ...
    subsamples = [samples[0][:num_samples],
